...
<html>
  ...
  <?php
    ...
    $stmt = $pdo->query("SELECT * FROM transactions");
      print'<table class="table table-bordered table-striped table-hover"><tr class="thead-dark"><th>Sender</th><th>Reciever</th><th>Amount Transfered</th></tr>';
      while ( $row = $stmt->fetch(PDO::FETCH_ASSOC) ) {
          print "<tr><td>".$row["from"]."</td><td>".$row["to"]."</td><td>".$row['amount']."</tr>";
      }
  ?>
  </div>   
    </body>
