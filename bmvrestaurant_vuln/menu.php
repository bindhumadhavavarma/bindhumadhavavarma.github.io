...
if(isset($_POST['add1']))$_SESSION['item_id']=1;
if(isset($_POST['add2']))$_SESSION['item_id']=2;
if(isset($_POST['add3']))$_SESSION['item_id']=3;
if(isset($_POST['add4']))$_SESSION['item_id']=4;
if(isset($_POST['add5']))$_SESSION['item_id']=5;
if(isset($_POST['add6']))$_SESSION['item_id']=6;
if(isset($_POST['add7']))$_SESSION['item_id']=7;
if(isset($_POST['add8']))$_SESSION['item_id']=8;
if(isset($_POST['add1'])||isset($_POST['add2'])||isset($_POST['add3'])||isset($_POST['add4'])||
isset($_POST['add5'])||isset($_POST['add6'])||isset($_POST['add7'])||isset($_POST['add8'])){
  ...
  <div class="container" id="menuu">
    ...
    <div class="col-lg-6" id="item">
      <div id="item1">
        ...
        <span>Chicken Dum Biriyani</span>
        <span id="cost">Rs.220 <input class="btn btn-primary btn-sm" type="submit" name="add1" value="Add to Cart" ></span>
      </div>
    </div>
    ...
    <div class="col-lg-6" id="item">
      <div id="item1">
        ...
        <span>Special Chicken Biriyani</span>
        <span id="cost">Rs.240 <input class="btn btn-primary btn-sm" type="submit" name="add2" value="Add to Cart"></span>
      </div>
    </div>
    ...
    <div class="col-lg-6" id="item">
      <div id="item1">
        ...
        <span>Chicken Wings Biriyani</span>
        <span id="cost">Rs.230 <input class="btn btn-primary btn-sm" type="submit" name="add3" value="Add to Cart" ></span>
      </div>
    </div>
    ...
    <div class="col-lg-6" id="item">
      <div id="item1">
        ...
        <span>Chicken Kebab Biriyani</span>
        <span id="cost">Rs.250 <input class="btn btn-primary btn-sm" type="submit" name="add4" value="Add to Cart" ></span>
      </div>
    </div>
    ...
    <div class="col-lg-6" id="item">
      <div id="item1">
        ...
        <span>Chicken Keema Biriyani</span>
        <span id="cost">Rs.250 <input class="btn btn-primary btn-sm" type="submit" name="add5" value="Add to Cart"></span>
      </div>
    </div>

    <div class="col-lg-6" id="item">
      <div id="item1">
        <img src="images/bir7.jpg" alt="" id="itim">
        <span>Mutton Dum Biriyani</span>
        <span id="cost">Rs.300 <input class="btn btn-primary btn-sm" type="submit" name="add6" value="Add to Cart"></span>
      </div>
    ...
    <div class="col-lg-6" id="item">
      <div id="item1">
        <img src="images/bir8.jpg" alt="" id="itim">
        <span>Special Mutton Biriyani</span>
        <span id="cost">Rs.340 <input class="btn btn-primary btn-sm" type="submit" name="add7" value="Add to Cart"></span>
      </div>
    </div>
    ...
    <div class="col-lg-6" id="item">
      <div id="item1">
        <img src="images/bir1.jpg" alt="" id="itim">
        <span>Special Fish Biriyani</span>
        <span id="cost">Rs.260 <input class="btn btn-primary btn-sm" type="submit" name="add8" value="Add to Cart"></span>
      </div>
    </div>
