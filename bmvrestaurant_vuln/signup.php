...
<body>
      ...
      <form method="POST" enctype="multipart/form-data">
        <div class="form-row">
          ...
          <div class="col-md-12 mb-3">
            <img id="output" src="" alt="" style="max-width: 200px; max-height: 200px; margin-top: 10px;">
            <label for="validationServer01">Profile Picture</label>
            <input type="file" class="form-control " name="profile_pic" onchange="previewImage(event);" required>
          </div>
  ...
  <footer class="panel-footer" id="foot">
    <div class="container">
      ...
      <div class=" col-sm-12" style="text-align: center;">&copy; Copyright Bindhu Madhava Varma 2020</div>
